...
import warnings
import statistics
from train_diff_agg import compute_metrics
...
def main():
    ...
    if args.training_label == "naive":
        with open('annotation/annotated_result/all/setting2/train.jsonl', 'r') as file:
            for line in file:
                data = json.loads(line)
                id_text_label = [
                    data['sample_id'],
    ...
    if args.valid_label == "naive":
        with open('annotation/annotated_result/all/setting2/valid.jsonl', 'r') as file:
            for line in file:
                data = json.loads(line)
                id_text_label = [
                    data['sample_id'],
    ...
    if args.testing_label == "naive":
        with open('annotation/annotated_result/all/setting2/test.jsonl', 'r') as file:
            for line in file:
                data = json.loads(line)
                id_text_label = [
                    data['sample_id'],
    ...
    with open('annotation/annotated_result/all/setting2/expert.jsonl', 'r') as file:
        for line in file:
            data = json.loads(line)
